...
- 🔍 **「完成」自带凭证**
  ...
  「完成」由机械核查对照实际结果来判定——从来不是听 AI 的一句自我声明。负责核查的是独立验证者，不是做事的那个 AI 给自己打分。实在做不动时，它不会无限空转：带着凭证诚实地停下来，向你报告。
...
- **你的 AI 一切如旧** — 人格、指令文件、积累的记忆一概不动，只是在它周围加几个文件。
...
| 模块 | 做什么 | 状态 |
| --- | --- | --- |
| **Caty Agent Harness** | AI 智能体的任务基座 — 重试、检查点与完成判定 | 已公开・MIT |
