...
<p align="center"><sub>generation: <code>d6622d6</code> (2026-08-28T07:16:57Z) · verify: <a href="https://api.github.com/repos/caty-ai/caty-agent-harness/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
