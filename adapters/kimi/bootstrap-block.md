...
CATY PAUSE AWARE v1
Before any harness CONSULT, rubric, or CHECKPOINT step, check whether `.caty-agent-harness/DISABLED` exists in the workspace. If it exists, skip all harness instructions in this block and continue with native Kimi Code behavior.
