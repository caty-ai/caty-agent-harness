...
- **การหลอกว่า "เสร็จ" หยุดทำงานบนโมเดลที่อ่อนกว่า — งานที่เสร็จจริงเพิ่มขึ้นสามเท่า** บน Claude Haiku 4.5 (โมเดลที่มีความสามารถต่ำกว่า) การอ้างว่า "เสร็จ" ทั้งที่ยังอ่านงานไม่ครบ ลดลงจาก 98% เหลือ 8% ของการอ้างว่าเสร็จทั้งหมด (222/226 → 2/26, 30 รันต่อฝั่ง) — และอัตราการทำงานสำเร็จที่ยืนยันแล้วเพิ่มขึ้นจาก 13% เป็น 43%
