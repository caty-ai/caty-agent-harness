...
|---|---|---|---|
| Claude Haiku 4.5 | 13% → **43%** (+30 pt, p=0.008) | 94% → **5%** | **ครึ่งเดียวหรือน้อยกว่า** |
| GPT-5.6 Luna (Codex) | อยู่ในแผน | — | — |
| โมเดลภายในเครื่อง (Ollama) | อยู่ในแผน | — | — |

<sub>¹ อ้างว่า "เสร็จ" ทั้งที่ยังไม่ได้อ่านงานที่ทำ — วัดจาก transcript การเรียกใช้ tool ไม่ใช่จากการรายงานตัวเอง (247 → 2 ครั้งที่อ้าง) งานขนาด 150K–300K token, รันคู่เทียบ 30 ครั้งต่อฝั่ง ให้คะแนนโดยเครื่องล้วน ๆ รวมจุดอ่อนไว้ด้วย: [ตัวเลขและข้อจำกัดฉบับเต็ม (ภาษาอังกฤษ)](docs/benchmark.md)</sub>
