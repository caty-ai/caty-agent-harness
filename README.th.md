...
อีกหนึ่งเลนที่ปิดผนึก **EV-007 / EV-007b** วัดอีกครึ่งหนึ่งของข้ออ้าง — วงจรการเรียนรู้ ผลคือ **ไม่มี learning event และไม่มีการรันหลัก**: การรีวิวข้ามโมเดล fail-close ถึงสองครั้ง และเมื่อสร้างเครื่องมือวัดชุดที่สองเสร็จ harness + haiku ก็แก้ทุกคลังข้อมูลที่เรามีได้ที่ 19–20/20 — จึงไม่เหลือกลุ่มความผิดพลาดซ้ำให้วงจรทำงานด้วย สิ่งที่เลนนี้ให้จริง ๆ คือการเปลี่ยนแปลงของผลิตภัณฑ์ที่เผยแพร่ใน v0.24.0 (การเลื่อนขั้นนับการเกิดซ้ำเป็นจำนวน session ที่ต่างกัน ไม่ใช่สัปดาห์ ISO): [หยุดตรงไหนและเพราะอะไร (ภาษาอังกฤษ)](docs/benchmark.md#ev-007)
