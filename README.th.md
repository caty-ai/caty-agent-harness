...
อีกหนึ่งเลน **EV-007 / EV-007b** วัดอีกครึ่งหนึ่งของข้ออ้าง — วงจรการเรียนรู้ ผลคือ **ไม่มี learning event ทั้งสองครั้ง** EV-007 จบลงเมื่อการรีวิวข้ามโมเดล fail-close จากนั้น EV-007b จึงสร้างเครื่องมือวัดแบบฝังกับดัก (trap) ที่ทำให้ความผิดพลาดเกิดซ้ำได้จริง (ในแขนที่เรียนรู้ 8 จาก 8 คลาสความผิดพลาดเกิดซ้ำในทุกรอบบน v0.24.0) และรันการรันหลักที่ปิดผนึกไว้บนเครื่องมือนั้น — แต่การรีวิวปฏิเสธการอ้างอิงทุกรายการ เพราะการตรวจการอ้างอิงของตัวรีวิวไม่เข้ากับรูปแบบบรรทัด flush ที่ Stop hook เขียนออกมา ซึ่งคือสิ่งที่การรันนี้ค้นพบในตัวผลิตภัณฑ์ จำนวนการเลื่อนขั้น: 0 ดังนั้นผลของวงจรต่อความผิดพลาดที่เกิดซ้ำจึงยัง **ไม่ถูกวัด** — ไม่ได้ถูกแสดงว่าได้ผล และไม่ได้ถูกแสดงว่าไม่ได้ผล สิ่งที่เลนนี้ให้จริง ๆ คือการเปลี่ยนแปลงของผลิตภัณฑ์ที่เผยแพร่ใน v0.24.0 (การเลื่อนขั้นนับการเกิดซ้ำเป็นจำนวน session ที่ต่างกัน ไม่ใช่สัปดาห์ ISO): [หยุดตรงไหนและเพราะอะไร (ภาษาอังกฤษ)](docs/benchmark.md#ev-007)
