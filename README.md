...
- **Fake "done" stops on a weak model — three times as many jobs actually finish.** On Claude Haiku 4.5 (a lower-capability model), "done" claims with the work left unread fell from 98% to 8% of completion claims (222/226 → 2/26, 30 runs/arm) — and verified completions rose from 13% to 43%.
